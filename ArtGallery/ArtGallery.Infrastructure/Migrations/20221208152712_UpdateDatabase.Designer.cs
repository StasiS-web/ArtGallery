...
namespace ArtGallery.Infrastructure.Migrations
{
    ...
    [Migration("20221208152712_UpdateDatabase")]
            ...
            modelBuilder.Entity("ArtGallery.Infrastructure.Data.Models.BlogPost", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            UrlImage = "https://res.cloudinary.com/dnvg6uuxl/image/upload/s--R7kMhOFw--/c_fit,h_400,w_400/v1646157537/app_gallery/image-from-id-556828-jpeg_pvzrkd.jpg",
                            UserReaction = 0
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Title = "Italian Art",
                            UrlImage = "https://res.cloudinary.com/dnvg6uuxl/image/upload/s--0W3cGmHR--/c_fit,h_400,w_400/v1646156702/app_gallery/Artist_painting-jpeg_nn02fh.jpg",
                            UserReaction = 0
                        },
                        new
                        {
                            ...
                            UrlImage = "https://res.cloudinary.com/dnvg6uuxl/image/upload/s--qQQZbUqy--/c_fit,h_400,w_400/v1648590618/app_gallery/arun-prakash-unsplash_tuluof.jpg",
                            UserReaction = 0
                        },
                        new
                        {
            ...
            modelBuilder.Entity("ArtGallery.Infrastructure.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2022, 12, 8, 0, 0, 0, 0, DateTimeKind.Local),
